...
{
    class ChiclayoCity : City, IObtainTaxes
    {
        public ChiclayoCity(string name, float taxes, float priceBuild, float pricePark, float buildsCount, bool building1, bool park1, bool building2,
